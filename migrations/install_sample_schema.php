...
class install_sample_schema extends \phpbb\db\migration\migration
{
	...
	{
		return $this->db_tools->sql_column_exists($this->table_prefix . 'users', 'user_sentiment');
	}
	...
	public function update_schema()
	{
		return array(
			'add_tables'		=> array(
				$this->table_prefix . 'senky_sentiment_table'	=> array(
					'COLUMNS'		=> array(
						'sentiment_id'			=> array('UINT', null, 'auto_increment'),
						'sentiment_name'			=> array('VCHAR:255', ''),
					),
					'PRIMARY_KEY'	=> 'sentiment_id',
				),
			),
			'add_columns'	=> array(
				$this->table_prefix . 'users'			=> array(
					'user_sentiment'				=> array('UINT', 0),
				),
			),
		);
	}
	...
	public function revert_schema()
	{
		return array(
			...
			'drop_tables'		=> array(
				$this->table_prefix . 'senky_sentiment_table',
			),
		);
	}
}
