...
namespace senky\sentiment\cron\task;
...
class sample extends \phpbb\cron\task\base
{
	...
	public function run()
	{
		...
		$this->config->set('sentiment_cron_last_run', time(), false);
	}
	...
	{
		return $this->config['sentiment_cron_last_run'] < time() - $this->cron_frequency;
	}
}
